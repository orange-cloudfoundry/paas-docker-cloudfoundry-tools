...
CF_CLI_VERSION="8.19.0" # renovate: datasource=github-releases depName=cloudfoundry/cli
SPRUCE_BIN = "/usr/local/bin/spruce"
SPRUCE_VERSION = "1.35.19" # renovate: datasource=github-releases depName=geofffranks/spruce
