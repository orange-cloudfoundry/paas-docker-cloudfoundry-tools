...
BOSH_CLI_VERSION="7.8.2" # renovate: datasource=github-releases depName=cloudfoundry/bosh-cli
CF_CLI_VERSION="8.8.3" # renovate: datasource=github-releases depName=cloudfoundry/cli
