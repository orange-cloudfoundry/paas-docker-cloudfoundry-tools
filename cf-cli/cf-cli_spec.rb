...
CF_CLI_VERSION="8.6.0" # renovate: datasource=github-release-attachments depName=cloudfoundry/cli
SPRUCE_BIN = "/usr/local/bin/spruce"
SPRUCE_VERSION = "1.30.2" # renovate: datasource=github-release-attachments depName=geofffranks/spruce
RUBY_VERSION = "3.1"
