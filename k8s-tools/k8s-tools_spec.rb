...
KAPP_VERSION="0.63.2" # renovate: datasource=github-releases depName=k14s/kapp
...
KUTTL_VERSION="0.18.0" # renovate: datasource=github-releases depName=kudobuilder/kuttl
RUBY_VERSION = "3.1"
