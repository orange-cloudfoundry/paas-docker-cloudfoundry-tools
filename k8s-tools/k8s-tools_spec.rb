...
KAPP_VERSION="0.62.0" # renovate: datasource=github-releases depName=k14s/kapp
...
KUTTL_VERSION="0.16.0" # renovate: datasource=github-releases depName=kudobuilder/kuttl
RUBY_VERSION = "3.1"
